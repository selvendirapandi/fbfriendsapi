...
abstract class BaseFacebook
{
   ...
   */
  // This function changed to make this work in codeignitor  
 protected function getCode() {
    $server_info = array_merge($_GET, $_POST, $_COOKIE, $_REQUEST);
	//echo '<pre>';print_r($server_info);exit;
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    $opts = self::$CURL_OPTS;
	$opts[CURLOPT_SSL_VERIFYPEER] = false;  // This code added to make this work in codeignitor  
